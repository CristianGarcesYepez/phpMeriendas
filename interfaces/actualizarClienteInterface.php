<?php
    ...
    if ($_POST['ID'] != null and $_POST['Nombre'] != null and $_POST['Correo'] != null and $_POST['Telefono'] != null and $_POST['Direccion'] != null) { // 1. Validar datos que llegan del formulario
        ...
        $nroFilas = actualizarCliente($id,$nombre,$correo,$telefono,$direccion); // 4. Llamar a la funcion actualizarCliente del modelo
